...
import { useOpenAi, useOpenAiProps } from '@/hooks/openai/useOpenAi';

export default function useMuscleGroups(props: useOpenAiProps) {
  const {prompt: exerciseName} = props;
